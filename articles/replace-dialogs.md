...
description: ダイアログを業務プロセス フローまたはキャンバス アプリに置き換える
ms.custom: ''
ms.date: 08/02/2018
ms.reviewer: ''
ms.service: flow
...
- flowmaker
- enduser
ms.openlocfilehash: 16d1323834e199ebf96fc6e5728bc3ad11bed78f
ms.sourcegitcommit: 83e22ff7d539b02573548df5ca2a8bc41ea48227
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 11/10/2020
ms.locfileid: "4477327"
---
...
|---------|---------|---------|
|ページ     | 有効 <br/> (業務プロセス フロー)    | 有効 <br/> (アプリ画面)        |
|プロンプトのみ   |  無効    |  有効 <br/> (ラベル)        |
|プロンプトと応答     |  有効 <br/> (エンティティ属性のみ)    | 有効 <br/> (ラベルと入力フィールド)    |
|入力引数     |  制限あり <br/> (業務プロセス ステージ内のステップ)    | 有効 <br/> (クエリ文字列パラメーター)     |
|変数   |  無効     |  有効       |
|クエリ変数    |  無効     |  有効     |
|条件分岐ロジック    |  有効     | 有効 <br/>  (アプリ内の任意の画面に移動)    |
|再利用 <br/> (子ダイアログとして起動)   |  無効     | 有効 <br/> (アプリ内の任意の画面に移動、異なるアプリを新しいウィンドウで起動)     |
|開始/終了時にワークフローを実行    |   有効      |  無効 <br/> (代わりにフローを使用)  |
|入力時にワークフローを実行    | 有効    | 無効 <br/> (代わりにフローを使用)   |
|ページの切り替え時にワークフローを実行   |  有効       | 無効 <br/> (代わりにフローを使用)    |
|URL を使用して開始  |   無効      |  有効     |
|セッションのログ記録    |  有効       |  無効     |
|SDK サポート   |  有効     |  有効     |
